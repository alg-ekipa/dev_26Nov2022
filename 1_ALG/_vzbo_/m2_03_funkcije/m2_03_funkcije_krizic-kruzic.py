...
while status_igre== -1:
    ...
    # dodjela oznake igraču, prvi je  X, a drugi O
    if igrac == 1:
        oznaka_igraca = 'X'
    else:
        oznaka_igraca = 'O'

    # upis znaka X ili O na ploču prema odabranome
    if izabrano_polje == 1 and polje_na_ploci[1] == 1:  # provjera da je polje prazno, da nema već X ili O na njemu
    ...
    else:       # ako ima na njemu već X ili O
