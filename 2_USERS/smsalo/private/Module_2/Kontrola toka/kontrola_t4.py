'''
# djeljenje na riječi kroz određeni znak SPLIT
...
tekst1=tekst.lower()
tekst_lista=tekst1.split(' ')
print(tekst_lista)
print()

testni_1='\nrijec druga treca.'
testni_1_1=testni_1.split(' ')
print(testni_1_1[0].replace('\n', ''))
print(testni_1_1[2].replace('.', ''))
...
if a in tekst:
    print(f'Riječ {a} se u tekstu nalazi {broj} puta')
else:
    print ('nema rijeci')
print()
...
for rijec in lista_rijeci:
    if rijec == trazena_rijec:
        brojac +=1
print(f'Rijec {trazena_rijec} se pojavljuje {brojac} puta.')
print()
