...
def dodavanje_korisnika(): #1#
    ...
    while len(Korisničko_Ime)<1:
        Korisničko_Ime = input('Korisničko Ime je manje od 1 znaka, pokušajte ponovo: ')
    Ime = input ('Unesi Ime novog Korisnika: ')
    while len(Ime)<1:
        Ime = input('Ime je manje od 1 znaka, pokušajte ponovo: ')
    Prezime = input ('Unesi Prezime novog Korisnika: ')
    while len(Prezime)<1:
        Prezime = input('Prezime je manje od 1 znaka, pokušajte ponovo: ')
