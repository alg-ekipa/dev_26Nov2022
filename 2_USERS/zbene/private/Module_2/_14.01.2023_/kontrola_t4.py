...
for rijec in razdvojenac:
    if '.' in rijec:
        razdvojenac[razdvojenac.index(rijec)] = rijec.replace('.','')
    elif ',' in rijec:
        razdvojenac[razdvojenac.index(rijec)] = rijec.replace(',','')
    elif '\n' in rijec:
        razdvojenac[razdvojenac.index(rijec)] = rijec.replace('\n','')
...
broj = razdvojenac.count(rijec)
if rijec in tekst:
    print (f'Riječ {rijec} se pojavljuje {broj} puta')
else:
    print(f'Nema riječi')
