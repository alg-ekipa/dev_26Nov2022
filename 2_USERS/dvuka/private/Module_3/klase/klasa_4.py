class Ucenik:
    ...
    #meoda za ispis učenika koji imaju ocjenu 1
    def ispis_1(self):
        if self.ocjena==1:
            print(f'Učenik {self.ime} {self.prezime} ma ocjenu 1')
...
#prolazak kroz listu objekata, nad svakim objektom
for ucenik in lista_objekata_ucenika:
    #ucenik.ispis()          #lijepi ispis naših unosa odnosno objekta u listi
    ucenik.ispis_1()        #ispis učenka s ocjenom 1
