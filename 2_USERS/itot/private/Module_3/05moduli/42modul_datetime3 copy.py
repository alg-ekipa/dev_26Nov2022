...
# kreiranje objekta datetime preko ulaznog stringa odgovarajućeg oblike
...
datum_korisnik1 = input('Unesite datum formata  ime_mjeseca(eng.) dd yyyy:\n')
datum_korisnik_obj1 = dt.datetime.strptime(datum_korisnik1,'%b %d %Y')
print(datum_korisnik_obj1.date())

# TO DO: 
# Funkcije za ispis samo datuma, ispis samo vremena, koliko ima od sadašneg trenutna do datuma koji je unio korisnik
