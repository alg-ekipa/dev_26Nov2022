...
def handle_keypress(event): # kada su u pitanju eventovi, funkcija u nazivu sadrži handle_..., a argument joj je event
    ...
    label_tekst_var.set(unesena_slova) #kako krenemo pisati ovo se izbriše i krene tekst kojeg pišemo
...
# kada nam je neki label ispisni, koristimo parametar textvariable i navodimo što se ispisuje
label_ispis.grid(row=1,column=0)


# POVEZIVANJE SA FUNKCIJOM NAD ELEMENTOM ROOT
