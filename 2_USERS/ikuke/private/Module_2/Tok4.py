...
"""provjera = input("Unesi rijec: ")

broj = lista_rijeci.count(provjera)

if provjera in lista_rijeci:
    print(f"Rijec {provjera} se ispisuje {broj} u tekstu.")
"""

"""
for rijec in lista_teksta:
    if "." in rijec:
        lista_teksta[lista_teksta.index(rijec)] = rijec.replace(".", "")
    elif "," in rijec:
        lista_teksta[lista_teksta.index(rijec)] = rijec.replace(",", "")
    elif "\n" in rijec:
        lista_teksta[lista_teksta.index(rijec)] = rijec.replace("\n", "")
...
trazena_rijec = input("Unesi rijec: ")
brojac = 0
...
print(f"Rijec {trazena_rijec} se ispisuje {brojac} u tekstu.")