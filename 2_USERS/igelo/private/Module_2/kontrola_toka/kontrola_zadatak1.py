...
razdvojeni = testni.split(' ')          RAZDVAJANJE RIJEČI U TEKSTU
print(razdvojeni)
"""

"""
testni = 'jedan Dva TRA'
testni = testni.lower()
print(testni)                               PRETVARANJE SVE U MALA SLOVA
...
if a in tekst:
    print (f'Riječ {a} se pojavljuje {broj} puta u tekstu')
else:
    print ('Nema riječi')
"""

trazena_rijec = input('Unesi traženu riječ: ')
brojac = 0

for rijec in lista_rijeci:
    if rijec == trazena_rijec:
        brojac+= 1
print(f'Riječ {trazena_rijec} pojavljuje se u tekstu {brojac} puta.')
